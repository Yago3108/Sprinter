                ...
                children: [
                    TextButton(
                      ...
                      ScaffoldMessenger.of(context).showSnackBar(
                        const SnackBar(content: Text("Atividade iniciada"),backgroundColor: Color.fromARGB(255, 5, 106, 12),),
                      );}
                      , child: Text("INICIAR"),
                      ),
                    ElevatedButton.icon(
                    ...
                    onPressed: () async {
                      ...
                      ScaffoldMessenger.of(context).showSnackBar(
                        const SnackBar(content: Text("Atividade salva"),backgroundColor: Color.fromARGB(255, 5, 106, 12),),
                      );
                    },
                  ),
                ],
